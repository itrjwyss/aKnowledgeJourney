package com.powerwtechnology.salamalist.activities;
...
import com.powerwtechnology.salamalist.R;
import com.powerwtechnology.salamalist.adapters.RoadSignListAdapter;
import com.powerwtechnology.salamalist.objects.RoadSign;
...
public class RoadSignListActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_roas_sign_list);
    ...
    public boolean onCreateOptionsMenu(Menu menu) {
        ...
        getMenuInflater().inflate(R.menu.menu_roas_sign_list, menu);
        return true;
    }
